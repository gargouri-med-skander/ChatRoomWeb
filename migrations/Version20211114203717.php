 ...
 */
final class Version20211114203717 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX id_user ON theme_membre');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX id_user ON theme_membre (id_user)');
    }
}
