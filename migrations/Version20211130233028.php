 ...
 */
final class Version20211130233028 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE theme DROP messages');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE theme ADD messages JSON DEFAULT NULL');
    }
}
