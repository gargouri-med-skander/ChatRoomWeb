 ...
 */
final class Version20211129063018 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX nom_theme ON theme');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX nom_theme ON theme (nom_theme)');
    }
}
